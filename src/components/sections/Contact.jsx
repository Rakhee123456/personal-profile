...
const ContactForm = ({ bg_color }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setResponseMessage(
      "Thanks For trying Contact Form. This site is not connected to any backend, so your message will not be sent. Please use WhatsApp or manually send an email to rakheepandey5712@gmail.com for further communication."
    );
    setShowFlash(true);
    ...
    >
      ...
      <div className="w-full md:w-1/2">
        ...
        <p className="text-light mb-6">
          Thank you for visiting Rakhee Pandey's portfolio! Please fill out the
          contact form below to get in touch for any inquiries, collaborations,
          or feedback.
        </p>
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-[hsla(164,38%,18%,1)] to-[hsla(158,77%,77%,1)] text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-600 shadow-sm shadow-white"
          >
            Submit
          </button>
        </form>
