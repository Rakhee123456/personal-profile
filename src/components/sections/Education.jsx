      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-16 justify-evenly">
        ...
        <div className="min-w-full flex justify-evenly md:items-start">
          ...
          <div className="flex flex-col mt-5">
            <div className="mb-5 md:mb-0">
              <h1 className="text-xl md:text-2xl font-bold text-white">
                Veena Vidya Mandir, Jaleshwar{" "}
              </h1>
              <p className="text-light text-sm md:text-base mt-2">
                Passed Year: 2017, with 3.70 GPA <span className="text-primary">10th Grade</span>
              </p>
            </div>
            ...
            <div className="mb-8 md:mb-0 ">
              <h1 className="text-xl md:text-2xl font-bold text-white">
                Nepal Engineering College, Changunarayan Nepal{" "}
                
              </h1>
              <p className="text-light text-sm md:text-base mt-2">
                Passed Year: 2019-2024, with 3.78 CGPA <span className="text-primary">Graduated</span>
              </p>
            </div>
          </div>
          ...
          <div className="mb-8 mt-5 md:mb-0">
            <h1 className="text-xl md:text-2xl font-bold text-white">
              V.S. Niketan Secondary School, Kathmandu Nepal{" "}
              
            </h1>
            <p className="text-light text-sm md:text-base mt-2">
              Passed Year: 2017-2019, with 3.42 CGPA <span className="text-primary">12th Grade</span>
            </p>
          </div>
        </div>
